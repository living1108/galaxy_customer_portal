                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::tel("institution",null,['id' => 'institution', 'autocomplete' => 'institution', 'class' => 'form-control', 'placeholder' => utrans("billing.institution--placeholder")]) !!}
                        </div>
                        <div class="form-group">
                            <label for="transit">{{utrans("billing.transit")}}</label>
                            {!! Form::tel("transit",null,['id' => 'transit', 'autocomplete' => 'transit', 'class' => 'form-control', 'placeholder' => utrans("billing.transit--placeholder")]) !!}
                        </div>
